...
<div class="panel shadow-sm">
    <div class="panel-body">
        <div class='form-group'>
			{!! html()->label()->class('control-label')->for('nama_instansi')->text('Nama Instansi') !!}
			{!! html()->text('nama_instansi',$data->nama_instansi)->placeholder('Type Nama Instansi here')->class('form-control')->id('nama_instansi') !!}
		</div>
    </div>
</div>
